...
- [init-and-onboarding.md](init-and-onboarding.md) — `splash init`: scan, scaffold, write the
  loader and project hook configuration; and fresh-clone trust onboarding. *(UC3, UC6)*
